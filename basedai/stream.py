...
class BTStreamingResponseModel(BaseModel):
    ...
    It is used within the :func:`StreamingBrainresponder` class to create a :func:`BTStreamingResponse` object, which is responsible for handling
...
class StreamingBrainresponder(basedai.Brainresponder, ABC):
    """
    The :func:`StreamingBrainresponder` class is designed to be subclassed for handling streaming responses in the Basedai network.
    ...
    class BTStreamingResponse(_StreamingResponse):
        ...
        of tokens within the Basedai network. It is used internally by the StreamingBrainresponder class to manage the response
        streaming process, including sending headers and calling the token streamer provided by the subclass.

        This class is not intended to be directly instantiated or modified by developers subclassing StreamingBrainresponder.
